...
async function saveConfig(formData: FormData) {
  ...
  await fetch(`${API_URL}/internal/v1/devices/${DEVICE_ID}/config`, {
    ...
    body: JSON.stringify({ flow_f1_pulses_per_liter: f1, flow_f2_pulses_per_liter: f2 }), cache: "no-store",
  });
  ...
  return (
    <main className="shell">
      ...
      {!config ? <section className="panel warning"><h2>Configuratie niet beschikbaar</h2><p>De webapp kan de actuele controllerconfiguratie niet ophalen.</p></section> : (
        <section className="panel"><h2>Flowmeters</h2><p>Kalibratiefactor per flowmeter. De Pico haalt wijzigingen automatisch van de VPS op.</p>
